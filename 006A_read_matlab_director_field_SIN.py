...
nfield = nm.DirectorField(
    mesh_lengths=(800,800,5), # (Lx, Ly, Lz)
...
data = loadmat('C:/Users/manzoni/Desktop/NEMAKTIS/Sin-Grating_alignment_matrices.mat')
...
nfield.save_to_vti('C:/Users/manzoni/Desktop/NEMAKTIS/POUYA_SIN_dir.vti')
...
wavelengths = np.linspace(0.55,0.55,1)
...
output_fields.save_to_vti("OUTPUTFIELD_SIN_POUYA")
